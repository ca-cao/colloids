...
! Real(8), Parameter ::Rcyl,rho
 ...
 Real(8),parameter  :: Rcyl   =2.5
 Real(8), Parameter :: rho    =0.2
 ...
 Real(8), Parameter :: lambdaA=3.0
 Real(8), Parameter :: lambdaB=3.0
 ...
 Character(len=20), Parameter :: sfile   = 'l3_0r2_5rho0_2.xyz'    !file name
