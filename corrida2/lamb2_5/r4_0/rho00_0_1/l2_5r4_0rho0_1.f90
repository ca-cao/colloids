...
! Real(8), Parameter ::Rcyl,rho
 ...
 Real(8),parameter  :: Rcyl   =4.0
 Real(8), Parameter :: rho    =0.1
 ...
 Real(8), Parameter :: lambdaA=2.5
 Real(8), Parameter :: lambdaB=2.5
 ...
 Character(len=20), Parameter :: sfile   = 'l2_5r4_0rho0_1.xyz'    !file name
